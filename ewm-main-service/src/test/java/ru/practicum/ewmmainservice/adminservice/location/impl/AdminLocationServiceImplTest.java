...
class AdminLocationServiceImplTest {
   ...
   private final ObjectMapper objectMapper;
    ...
    @Test
    void test1_createLocation_findChilds() throws NotFoundException, LocationException, JsonProcessingException {
        ...
        LocationFullDto res1 = service.createLocation(loc1);
        LocationFullDto res2 = service.createLocation(loc2);
        LocationFullDto res3 = service.createLocation(loc3);
        LocationFullDto res4 = service.createLocation(loc4);
        LocationFullDto result  = service.createLocation(newParent);

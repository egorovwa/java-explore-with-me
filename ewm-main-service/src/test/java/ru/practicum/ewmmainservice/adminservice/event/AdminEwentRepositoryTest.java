...
class AdminEwentRepositoryTest {
    ...
    void test1_1findForAdmin() throws IncorrectPageValueException {
        ...
        expected.add(event1);
        expected.add(event2);
        List<Event> result = adminEwentRepository.findForAdmin(userIds, catIds, states, start, end, locIds, pageable).toList();
    ...
    void test1_3findForAdmin_withSize1() throws IncorrectPageValueException {
        ...
        List<Event> result2 = adminEwentRepository.findForAdmin(userIds, catIds, states, start, end, locIds, pageable1).toList();

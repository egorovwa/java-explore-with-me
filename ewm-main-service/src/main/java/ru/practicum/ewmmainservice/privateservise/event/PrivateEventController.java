...
public class PrivateEventController {
    ...
    public List<EventShortDto> findAllEventByInitiatur(@Positive @PathVariable("userId") Long userId) throws NotFoundException {
        return eventService.findAllEventByInitiatur(userId);
    }
}
